      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="bg-white rounded-xl shadow-xl px-4 py-2.5 border border-slate-100"
          >
            <p className="text-xs font-semibold text-slate-800">Chat dengan kami</p>
            <p className="text-xs text-slate-500">Respon cepat!</p>
          </motion.div>
        )}
      </AnimatePresence>
